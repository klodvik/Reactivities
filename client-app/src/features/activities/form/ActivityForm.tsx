            ...
            render={({ handleSubmit, invalid, pristine }) => (
              <Form onSubmit={handleSubmit} loading={loading}>
                ...
                <Form.Group widths='equal'>
                  <Field<Date> name='date' placeholder='Date' date={true} value={activity.date} component={DateInput} />
                  <Field<Date> name='time' placeholder='Time' time={true} value={activity.time} component={DateInput} />
                </Form.Group>
